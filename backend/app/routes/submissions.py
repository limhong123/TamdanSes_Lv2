...
def parse_file_paths(
    ...
    if item.file_path and item.file_path not in result:
...
def submission_response(
    ...
    return {
        ...
        "student_name": get_student_name(student, db),
...
def notify_teacher_submission(
    ...
    try:
        send_push_notification(
            ...
            body=(
                f"{get_student_name(student, db)} submitted homework\n"
...
#
# submitted => show until teacher checks
# checked   => hide immediately
#
